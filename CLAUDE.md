...
- Le simulateur se pilote au tap, au clavier et par l'arbre d'accessibilité avec `axe`. La recette complète (boot, build, install, launch, capture, pilotage de l'UI, et ce que le simulateur ne peut pas montrer) est dans `docs/agents/simulator.md`.
